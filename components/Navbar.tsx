                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <SignedOut>
                            <SignInButton>
                                <Button
                                className="bg-white border border-green-600 text-green-600 rounded-full font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 hover:bg-green-50 transition-all cursor-pointer duration-200 hover:scale-105"
                                >
                                    Sign In
                                </Button>
                            </SignInButton>
