...
import { updateProfile, ProfileUpdateResult } from '@/lib/actions/profile'
...
const FormItem = ({ form }: { form: FormStats }) => {
    return (
        <Link href={`/forms/${form.id}`} className="block hover:bg-accent/50 transition-colors rounded-md">
            <div className="flex items-center justify-between p-4 border rounded-md hover:bg-muted/50 transition-colors">
                <div className="flex-1">
                    <div className="flex items-center gap-3">
                        <h4 className="text-xs sm:text-base font-medium">{form.title}</h4>
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose} >
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-scroll" >
                ...
                <Tabs defaultValue="profile" className="w-full overflow-y-scroll min-h-full">
